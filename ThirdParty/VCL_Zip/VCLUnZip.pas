...
type
 ...
 protected
  ...
  public
    ...
    procedure FilsList(FilesList: TStrings);
...
procedure TVCLUnZip.FilsList( FilesList: TStrings );
var
  i: Integer;
  finfo: TZipHeaderInfo;
begin
  FilesList.Clear;
  sortfiles.SortMode:=ByName;
  For i := 0 to Count-1 do
  begin
    finfo := sortfiles.Items[i] as TZipHeaderInfo;
    FilesList.Add(LowerCase(finfo.filename));
  end;
end;
