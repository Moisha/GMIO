...
{ Hierarchy -------------------------------------------------------------------}
  ...
  private
    ...
    procedure UpdateParent(const Logger: TLogLogger; Factory: ILogLoggerFactory);
  protected
...
begin
  ...
  try
    ...
    begin
      ...
      UpdateParent(Result, LoggerFactory);
    end;
  finally
...
procedure TLogHierarchy.UpdateParent(const Logger: TLogLogger; Factory: ILogLoggerFactory);
var
  Index: Integer;
...
begin
  ...
  if Index = 0 then
    ...
    Logger.FParent := GetLogger(Copy(Logger.Name, 1, Index - 1), Factory);
end;
