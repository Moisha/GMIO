...
interface
uses
  Windows, Messages, SysUtils, Classes, ActiveX, ComObj, Types,
  Contnrs, {cf 1.14.16}
...
begin
  ...
  for i:= 0 to Group.FItemList.Count - 1 do
    if Group.FItemList[i].FActive then
      ActiveList.Add(Group.FItemList[i]);
